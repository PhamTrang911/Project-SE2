...
.overlay {
	background-image: linear-gradient(to right, #008C5E, #489620);
...
<body>
    ...
    <div class="container" id="container">
        ...
        <div class="form-container sign-in-container">
            <form action="${pageContext.request.contextPath}/login/signin">
                <h1>Sign in</h1> 
        ...
        <div class="overlay-container">
            <div class="overlay">
                <div class="overlay-panel overlay-left">
                    <h1>Welcome The Bonsai Garden!</h1>
                    <p>To keep connected with us please login with your personal info</p>
                    <button class="ghost" id="signIn">Sign In</button>
                </div>
	                <div class="overlay-panel overlay-right">
	                    <h1>Hello, Friend!</h1>
	                    <p>Enter your personal details and start <br>shopping with us</p>
