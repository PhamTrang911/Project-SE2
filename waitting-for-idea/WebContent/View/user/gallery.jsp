                ...
                <div class="col-lg-12">
                    <div class="special-menu text-center">
                        <div class="button-group filter-button-group">
                            ...
                            <button data-filter=".bulbs">Live Plant</button>
                            <button data-filter=".fruits">Faux & Preserved Plants</button>
							<button data-filter=".podded-vegetables">Pots & Accessories</button>
							<button data-filter=".root-and-tuberous">Gift Cards</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-3 col-md-6 special-grid bulbs">
                    <div class="products-single fix">
                        <div class="box-img-hover">
                            ...
                            <img src="images/live-plant.jpg" class="img-fluid" alt="Image">
                            <div class="mask-icon">
                                <ul>
